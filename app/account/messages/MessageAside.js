...
const MessageAside = () => {
  return (
    <aside className="w-[310px] bg-white p-[20px_10px] 2xl:p-[30px_13px] flex flex-col gap-[46px]">
      {/* message */}
      <div className="relative flex items-center gap-5 border-b border-[#7F7789] p-4 2xl:py-[22px]">
        {/* left */}
        <Image
        ...
        {/* active */}
        <div className="absolute w-1 h-12 2xl:h-[60px] rounded-full -left-2 2xl:-left-3 bg-woro-blue"></div>
      </div>
    </aside>
  );
};
