    ...
    <header>
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-end space-x-[40px] 2xl:space-x-[55px]">
          <div>
            <Image src="/assets/images/logo.png" width="177" height="42" />
          </div>
        ...
        <div className="flex gap-[22px] ">
          ...
          <div
            ...
            className="flex space-x-4 items-center p-[6px_19px_6px_14px] rounded-[20px] shadow-[_0px_4px_20px_0px_rgba(190,_148,_243,_0.20)]"
          >
            {/* profile */}
            ...
            >
              <Image src="/assets/images/plan1.png" width="25" height="25" />
            </div>
