      ...
      {!itemSelected && (
        ...
        >
          ...
          <div
            ...
            className="group cursor-pointer hover:text-woro-blue hover:scale-125 transition-all duration-300 ease-linear  absolute top-[50px]  flex flex-col items-center gap-[6px]"
          >
            <svg
