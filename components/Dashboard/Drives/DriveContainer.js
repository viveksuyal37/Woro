  ...
  return (
    <div
      ...
      className={classNames(
        ...
        { "h-[61px] 2xl:h-[80px] 3xl:h-[97.5px] 4xl:h-[120px] p-[10px] 2xl:p-[14px_15px]": !expandedCard }
      )}
    >
    <div className="flex child:w-5 child:2xl:w-[27px] gap-7 ">
      <Image src='/assets/images/dashboard/onedrive.png' width='27' height='27' alt='drive'/>
      <Image src='/assets/images/dashboard/onedrive.png' width='27' height='27' alt='drive'/>
      <Image src='/assets/images/dashboard/onedrive.png' width='27' height='27' alt='drive'/>

    </div>
    <button className="text-center w-full text-[10px] 2xl:text-[12px] 3xl:text-[1rem] border py-1 3xl:py-2 rounded-[10px] text-woro-blue border-woro-blue">
      Content Library
    </button>
    </div>
  );
