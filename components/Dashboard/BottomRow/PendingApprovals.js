  ...
  return (
    <div
      ...
      className={classNames(
        ...
        {
          'w-full min-h-[66vh] h-[66vh] p-6 2xl:p-[46px]':
            expandedCard === cardId,
        },
        {
          'flex flex-col justify-between  w-[30.21vw] max-w-[700px] 5xl:max-w-[900px] p-[13px] 2xl:p-[20px] ':
            !expandedCard,
        },
      )}
    >
      ...
      {!expandedCard && (
        <div className='flex items-center justify-between mt-2 2xl:mt-4'>
          ...
          <button className='flex gap-1 items-center text-[10px] 2xl:text-[1rem] text-white  p-[8px_24px] 2xl:p-[12px_37px] rounded-[3px] bg-woro-blue'>
            <svg
